...
class EmployeeController extends Controller
{
   ...
   public function attendenceDeatailShow(Request $req)
   {
      ...
      if ($req->ajax()) {
         ...
         // return $attendenceDatail;

         return datatables()->of($attendenceDeatailShow)
            ->addIndexColumn()
            ->addColumn('actions', function ($attendenceDeatailShow) {
               return '
                    <a href="' . route('employee.attendanceShow', $attendenceDeatailShow->user_id) . '" class="btn btn-sm btn-warning">
                         View
                    </a>
                    <a href="' . route('employees.salaryBonus', $attendenceDeatailShow->user_id) . '" class="btn btn-sm btn-warning">
                        Bonus 
                    </a>
                  ';
            })
